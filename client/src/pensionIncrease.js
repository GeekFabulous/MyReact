           ...
           <Form >
            <FormGroup>
              ...
              <FloatingLabel
                ...
                label="Payment batch"
                              >
                <Form.Control type="text" placeholder="Payment batch" 
                onChange={(event) =>
              ...
              <FloatingLabel
                ...
                label="Date of First Appointment"
                              >
                <Form.Control type="date" placeholder="DOFA" 
                onChange={(event) =>
              ...
              <FloatingLabel
                ...
                label="Estimated Date of Retirement"
                              >
                <Form.Control type="date" placeholder="EDOR" 
                onChange={(event) =>
              ...
              <FloatingLabel
                ...
                label="Year of Retirement"
                              >
                <Form.Control type="date" placeholder="year of retirement"
                 onChange={(event) =>
